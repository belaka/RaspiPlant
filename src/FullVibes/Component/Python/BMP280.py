...
class BMP280(object):
    ...
    def read_pressure(self):
        ...
        compensated_temp = self._compensate_temp(raw_temp)
        #print "compensatedtemp:",compensated_temp
        raw_pressure = self.read_raw(BMP280_PRESSUREDATA)
        #print "rawpressure:",raw_pressure
...
if __name__=="__main__":
	...
	temperature = bmp.read_temperature()
        #bmp.read_sensor_data()
        print "Altitude:",altitude,"m Pressure:",pressure,"pa Temperature:",temperature
        time.sleep(.2)
