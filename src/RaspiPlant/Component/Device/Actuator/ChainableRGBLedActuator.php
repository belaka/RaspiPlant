...
class ChainableRGBLedActuator extends AbstractActuator {
    ...
    public function storeColor($red, $green, $blue) {
        # switch relay on
        $this->protocol->digitalWrite(self::STORE_COLOR_CMD, $red, $green, $blue);
    ...
    public function initChain($numLeds) {
        $this->protocol->digitalWrite(self::CHAINABLERGB_INIT_CMD, $this->pin, $numLeds, 0);
        sleep(parent::ACTUATOR_WAIT_TIME);
    ...
    public function testChain($numLeds, $testColor) {
        $this->protocol->digitalWrite(self::CHAINABLERGB_TEST_CMD, $this->pin, $numLeds, $testColor);
        sleep(parent::ACTUATOR_WAIT_TIME);
    ...
    public function patternChain($pattern, $led) {
        $this->protocol->digitalWrite(self::CHAINABLERGB_PATTERN_CMD, $this->pin, $pattern, $led);
        sleep(parent::ACTUATOR_WAIT_TIME);
    ...
    public function moduloChain($offset, $divisor) {
        $this->protocol->digitalWrite(self::CHAINABLERGB_MODULO_CMD, $this->pin, $offset, $divisor);
        sleep(parent::ACTUATOR_WAIT_TIME);
    ...
    public function levelChain($level, $reverse) {
        $this->protocol->digitalWrite(self::CHAINABLERGB_LEVEL_CMD, $this->pin, $level, $reverse);
        sleep(parent::ACTUATOR_WAIT_TIME);
