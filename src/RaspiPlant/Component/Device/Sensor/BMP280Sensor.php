...
class BMP280Sensor extends AbstractSensor
{
    ...
    public function __construct(I2CProtocol $protocol, $pin, $name, $debug = false)
    {
        ...
        if ($this->protocol->readU8(self::BMP280_CHIPID) != 0x58) {
        ...
        $this->protocol->write8(self::BMP280_CONTROL, 0x3F);
    }

    protected function _loadCalibration()
    {

        $this->cal_t1 = (int)$this->protocol->readU16(self::BMP280_DIG_T1);
        $this->cal_t2 = (int)$this->protocol->readS16(self::BMP280_DIG_T2);
        $this->cal_t3 = (int)$this->protocol->readS16(self::BMP280_DIG_T3);
        $this->cal_p1 = (int)$this->protocol->readU16(self::BMP280_DIG_P1);
        $this->cal_p2 = (int)$this->protocol->readS16(self::BMP280_DIG_P2);
        $this->cal_p3 = (int)$this->protocol->readS16(self::BMP280_DIG_P3);
        $this->cal_p4 = (int)$this->protocol->readS16(self::BMP280_DIG_P4);
        $this->cal_p5 = (int)$this->protocol->readS16(self::BMP280_DIG_P5);
        $this->cal_p6 = (int)$this->protocol->readS16(self::BMP280_DIG_P6);
        $this->cal_p7 = (int)$this->protocol->readS16(self::BMP280_DIG_P7);
        $this->cal_p8 = (int)$this->protocol->readS16(self::BMP280_DIG_P8);
        $this->cal_p9 = (int)$this->protocol->readS16(self::BMP280_DIG_P9);
